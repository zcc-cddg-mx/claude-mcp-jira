...
ROLES: dict[str, list[str]] = {
    "dev":    ["create_jira_issue", "get_jira_issue", "search_jira_issues", "add_comment_jira_issue", "link_jira_issues", "sync_git_worklogs", "register_git_repo", "list_git_repos", "report_git_worklogs", "get_code_agent_status", "get_pull_request_status", "get_workflow_status"],
    "lead":   ["create_jira_issue", "update_jira_issue", "get_jira_issue", "search_jira_issues", "add_comment_jira_issue", "assign_jira_issue", "set_priority_jira_issue", "link_jira_issues", "create_saz_request", "sync_git_worklogs", "register_git_repo", "list_git_repos", "report_git_worklogs", "run_code_agent", "get_code_agent_status", "create_azure_pull_request", "get_pull_request_status", "update_pull_request_status", "run_create_feature_pr_workflow", "get_workflow_status", "create_deployment_saz_workflow", "set_repo_branch_map"],

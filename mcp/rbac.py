...
ROLES: dict[str, list[str]] = {
    "dev":    ["create_jira_issue", "get_jira_issue", "search_jira_issues"],
    "lead":   ["create_jira_issue", "update_jira_issue", "get_jira_issue", "search_jira_issues"],
    "system": ["create_jira_issue", "update_jira_issue", "get_jira_issue", "search_jira_issues"],
}
